    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12 " >
      ...
      <div className="mb-12 animate-fade-in text-center">
        <div className="inline-flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-neon-cyan/20 to-neon-purple/20 border border-neon-cyan/30 flex items-center justify-center glow-cyan"> <Save /> </div>
          <h1 className="font-display text-2xl font-700 tracking-tight text-white">
            SVG<span className="shimmer-text">Editor</span>
          </h1>
        </div>
        <div className="flex gap-2 mt-1">
          <span className="px-3 py-1 rounded-full text-xs font-mono bg-sky-800 text-neon-cyan border border-neon-cyan/20"> Upload</span>
          <span className="px-3 py-1 rounded-full text-xs font-mono bg-[#b847ff] text-ink-400 border border-ink-600"> Edit</span>
          <span className="px-3 py-1 rounded-full text-xs font-mono bg-[#0D1A63] text-ink-400 border border-ink-600"> Download</span>
        </div>
      </div>

      <div className={`relative w-full max-w-lg cursor-pointer select-none rounded-2xl border   transition-all duration-300 animate-slide-up
          ${isDragOver
